...
IPF=subset(epim, idents="IPF")



data=GetAssayData(IPF, assay = "RNA", slot = "data" )

Idents(IPF)="celltype5"
...
#> because it is considered unstable. For more details, how to IPF forked
...
ht1 + ht2
saveRDS(cellchat, file="IPF_cellchat0.23.rds")
